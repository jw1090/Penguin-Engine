...
void GameState::Initialize()
{
	...
	ModelIO::LoadModel("../../Assets/Models/Jolleen/Jolleen_pose.model", mJolleenModel);
	ModelIO::LoadMaterial("../../Assets/Models/Jolleen/Jolleen_pose.model", mJolleenModel);
	ModelIO::LoadSkeleton("../../Assets/Models/Jolleen/Jolleen_pose.model", mJolleenModel);
	mJolleen = CreateRenderGroup(mJolleenModel);
...
void GameState::Render()
{
	...
	mStandardEffect.Begin();
		if (mDrawSkeleton)
		{
			...
			auto& skeleton = mJolleenModel.skeleton;
